...
public class MsgBox {
    ...
    public static boolean confirm(Component parent, String message) {
        ImageIcon icon = new ImageIcon("D:\\PRO1041\\Hope\\src\\hinhanh\\couple_question_mark_50px.png");
    ...
    public static void alert(Component parent, String message) {
        ImageIcon icon = new ImageIcon("D:\\PRO1041\\Hope\\src\\hinhanh\\Laptop Alert_48px.png");
    ...
    public static void alertSuccessful(Component parent, String message) {
        ImageIcon icon = new ImageIcon("D:\\PRO1041\\Hope\\src\\hinhanh\\cloud_checked_64px.png");
        JOptionPane.showMessageDialog(parent, message, "NHÀ SÁCH HOPE RIGHT HERE", JOptionPane.INFORMATION_MESSAGE, icon);
    }
}
