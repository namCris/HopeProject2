 ...
 * @author Thanh Lam
 */
public class KhoiDongJDialog extends javax.swing.JDialog {

    /**
     * Creates new form KhoiDongJDialog
     */
    public KhoiDongJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        setTitle("NHÀ SÁCH HOPE RIGHT HERE");
        setBackground(new java.awt.Color(255, 255, 255));
        setForeground(new java.awt.Color(250, 135, 135));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhoiDongJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KhoiDongJDialog dialog = new KhoiDongJDialog(new javax.swing.JFrame(), true);
